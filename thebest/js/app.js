...
$(document).ready(function(){   
    ...
    var mess = "<span>2020万事顺意！</span><span class='B-span2'>每天都要开开心心的</span><span>月亮和星星会不会互道心事</span><span class='B-span2'>上了生活的的贼船，就要做一个快乐的海盗</span>";
    $(".Barrage").append(mess);
    ...
    $(".buts").click(function(){
        ...
        if(!mes){
          // alert("你还没输入内容呢!")
          var Tipss = "<div class='Tipss'>好兄弟，您还没输入内容呢</div>";
          $("body").append(Tipss);
          setTimeout(function(){
            $(".Tipss").remove();
          },1500)
